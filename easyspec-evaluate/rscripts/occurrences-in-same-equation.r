...
if (length(args) < 4) {
  stop("Usage: occurrences-in-same-equation.r common.r input.csv output.png (individual) [example] [focus] [strategy]")
}
...
if (length(dat) != 0) {
  ...
  title = "Histogram of the number of occurrences of the same function in an equation"
